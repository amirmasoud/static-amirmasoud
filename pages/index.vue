<template>
  <div class="bg-gray-50">
    ...
    <section
      id="hello"
      class="container mx-auto px-4 sm:px-16 -mt-20 flex min-h-screen justify-items-center justify-center items-center"
    >
      <div class="space-y-14">
        ...
        >
          Hello! My name is Amirmasood
        </h1>
        <small class="w-full block text-right text-gray-400"
          >/AH-meer Ma-soud/</small
        >
      </div>
    </section>
            ...
            >
              ...
              >
                <p>
                  ...
                  Larvel/Vue.js digital products e-commerce
                </p>
                <p>GPA: 3.35 / 4</p>
              </div>
            </div>
        ...
        <li>
          <article>
            ...
            >
              ...
              >
                <p>
                  Final thesis on data collection and visualization
                  collaboration using Python
                </p>
                <p>GPA: 3.35 / 4</p>
              </div>
            </div>
          ...
          <article>
            ...
            >
              <h3
                class="font-semibold text-gray-900 md:col-start-3 md:col-span-6 xl:col-start-3 xl:col-span-7 mb-1 ml-9 md:ml-0"
              >
                Volunteer WordPress Developer, American Myalgic
                Encephalomyelitis and Chronic Fatigue Syndrome Society, USA,
                Remote
              </h3>
              <time
                datetime="2020-10-07T13:00:00.000Z"
    ...
    <section id="connect" class="container mx-auto py-16 px-4 sm:px-16">
      <h1 class="text-gray-900 font-bold text-3xl">Connect</h1>
      <span class="text-blue-500">______</span>
...
.hand-shake {
  -webkit-animation: hand-shake 0.7s ease-in-out infinite alternate both;
  animation: hand-shake 0.7s ease-in-out infinite alternate both;
}
</style>
